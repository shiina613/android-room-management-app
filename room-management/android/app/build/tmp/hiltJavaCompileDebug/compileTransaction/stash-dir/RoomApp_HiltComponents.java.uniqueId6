...
public final class RoomApp_HiltComponents {
  private RoomApp_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements RoomApp_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          TenantViewModel_HiltModules.KeyModule.class
      }
  )
