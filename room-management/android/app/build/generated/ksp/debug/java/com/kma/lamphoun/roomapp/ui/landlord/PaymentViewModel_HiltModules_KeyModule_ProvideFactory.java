...
public final class PaymentViewModel_HiltModules_KeyModule_ProvideFactory implements Factory<Boolean> {
  @Override
  public Boolean get() {
    return provide();
  }
  ...
  public static boolean provide() {
    return PaymentViewModel_HiltModules.KeyModule.provide();
  }
